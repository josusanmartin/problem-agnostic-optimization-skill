...
def test_progress_chart_renders_svg_with_tokens_axis(tmp_path: Path) -> None:
    ...
    assert '>https://github.com/josusanmartin/problem-agnostic-optimization-skill</text>' in svg
    assert ">-" not in svg
...
def test_progress_dashboard_renders_static_html(tmp_path: Path) -> None:
    ...
    assert ">https://github.com/josusanmartin/problem-agnostic-optimization-skill</a>" in html
